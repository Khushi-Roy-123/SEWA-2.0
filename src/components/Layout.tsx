...
import { HomeIcon, CalendarIcon, PillIcon, FileTextIcon, UserIcon, StethoscopeIcon, HeartbeatIcon, FaceSmileIcon, CurrencyDollarIcon, ChartBarIcon, QrCodeIcon, TruckIcon, KeyIcon, ShieldCheckIcon, XIcon, SearchIcon } from './Icons';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    const navItems = [
        ...
        { href: '/lookup', label: 'Patient Lookup', icon: <SearchIcon /> },
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 text-slate-800">
            {/* Desktop Sidebar */}
            <aside className="hidden md:flex md:w-64 flex-col fixed inset-y-0 z-40">
