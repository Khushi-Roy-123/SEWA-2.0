...
export const QrCodeIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h3m-3 3h3m7 7h2m-2-12h2m-2 4h2m-2 4h2M5 8H3V3h5v2M5 21H3v-5h5v2m13-13h-5V3h5v5m0 13h-5v5h5v-5z" />
    </svg>
);
...
export const StethoscopeIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.5 16a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM10 5.75V3h4v2.75" />
    </svg>
);
...
export const CardiologyIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
    </svg>
);

export const NeurologyIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 8h6M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" transform="rotate(90 12 12)" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);

export const DermatologyIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 3.517-1.009 6.789-2.731 9.586l-2.73-2.73a9.75 9.75 0 01-2.096-3.823 9.75 9.75 0 01.34-3.823A9.75 9.75 0 018 4.414z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0-3.517 1.009-6.789 2.731-9.586l2.73 2.73a9.75 9.75 0 012.096 3.823 9.75 9.75 0 01-.34 3.823A9.75 9.75 0 0116 19.586z" />
    </svg>
);

export const GastroenterologyIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6a4 4 0 100 8 4 4 0 000-8z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 14.5L18 18M18 18h-3.5M18 18v-3.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 9.5L6 6M6 6h3.5M6 6v3.5" />
    </svg>
);

export const DefaultSpecialistIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const HeartbeatIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 12h2.5l1.5-4 3 8 2-6 1.5 4H20" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC = () => (
    <svg className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01V8m0 0h.01M12 16v2m-3-4.5V12m6-4.5V12m-6 0h6m-6 0v2m6 0v2m-6-2h6" />
